...
public class RegistrationApiControllerTest {
  ...
  @Test
  public void register_existedUsername_shouldFailAnd400() throws Exception {
    ...
    mvc.perform(post("/api/registrations").contentType(MediaType.APPLICATION_JSON)
      .content(JsonUtils.toJson(payload))).andExpect(status().is(400)).andExpect(jsonPath("$.message")
